...
var fail_msg_frag=hr+"<div class=\"alert alert-danger\"role=\"alert\">Exploit Initialization FAILED!</br><a href=\"javascript:window.location.reload();\">Refresh this page</a> & try again...</span></b></div>";
var progress_msg_frag1=hr+"<div class=\"alert alert-info\" role=\"alert\">Exploit Initialization..."+br+"<span>Progress: ";
var progress_msg_frag2='%, please wait...</span></div>';
...
function initDEX()
{
	document.getElementById('dex').checked = true;
